package project.report.com.store.activity.login;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // send data
                intent.putExtra(project.report.com.store.activity.login.LoginActivity.KEY_USER_FROM_REGISTER, "");
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(checkValidate()){
                    ...
                    // send data
                    Intent intent = new Intent();
                    intent.putExtra(project.report.com.store.activity.login.LoginActivity.KEY_USER_FROM_REGISTER, emailInput);
    ...
    private boolean validatePassword() {
        ...
        if (passwordInput.isEmpty()) {
            ...
            et_password.setError("Password must contain minimum 5 characters");
            return false;
        }
        else {
