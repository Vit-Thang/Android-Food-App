...
import project.report.com.store.activity.MainActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intentRegister = new Intent(getBaseContext(), project.report.com.store.activity.login.RegisterActivity.class);
