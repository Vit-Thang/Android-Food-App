package project.report.com.store.activity.bill;
...
import project.report.com.store.adapter.BillAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv_bill.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intentBill = new Intent(getBaseContext(), project.report.com.store.activity.bill.BillDetailActivity.class);
