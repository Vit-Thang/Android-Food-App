package project.report.com.store.activity.user;
...
import project.report.com.store.activity.user.AddEditUserActivity;
...
public class AddUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        builder = new NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .setContentText("You have been deleted succesfully")
