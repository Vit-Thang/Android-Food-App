package project.report.com.store.activity.category;
...
public class AddCategoryActivity extends AppCompatActivity {
    ...
    public boolean onContextItemSelected(MenuItem item){
        ...
        if(item.getItemId() == MENU_ITEM_VIEW){
            ...
            Intent intent = new Intent(this, project.report.com.store.activity.category.AddEditCategoryActivity.class);
